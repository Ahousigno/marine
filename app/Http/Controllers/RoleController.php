...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('roles.index')->with("success",  "Enregistrement effectué!");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $role->syncPermissions($request->input('permission'));
        return redirect()->route('roles.index')->with("success",  "Mise à jour effectuée!");
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('roles.index')->with("success",  "Suppression Effectuée!");;
    }
}