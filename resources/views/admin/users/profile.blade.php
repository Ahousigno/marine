...
<ul class="d-flex nav nav-pills mb-0 text-center profile-tab nav-slider" data-toggle="slider-tab" id="profile-pills-tab"
    role="tablist">
    <li class="nav-item">
        <a class="nav-link show active" data-bs-toggle="tab" href="#profile-event" role="tab" aria-selected="false">Mes
            demandes</a>
    </li>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="false">Profil</a>
    </li>
    <div class="nav-slider-thumb position-absolute nav-link"
        ...
        <a class="nav-link active show" data-bs-toggle="tab" href="#profile-feed" role="tab" aria-selected="false">-</a>
    </div>
</ul>
</div>
</div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                {!! Form::label('password-confirm', 'Répetez le mot de passe') !!}<sup
                                    class="text-danger font-weight-bold">*</sup>
                        ...
                        <div class="row" style="display: none">
                            <div class="form-group col-md-6">
                                {!! Form::label('roles', 'Attribution des Rôles (selection multiple : ctrl + clic
                                droit)') !!}<sup class="text-danger fw-bold">*</sup>
