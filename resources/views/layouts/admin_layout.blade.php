        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    {{-- @if (Auth::user()->getRoleNames()[0] == 'Service Secretariat')--}}
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="user-menu" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="{{route('admin.users.index')}}">
                                    ...
                                    <span class="item-name"> Liste des agents</span>
                                </a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="position-relative iq-banner">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3 w-100">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <small
                                                            class="float-end font-size-12">{{ Carbon::parse($demande->created_at)->format('d F Y') }}
                                                            à
                                                        </small>
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                ...
                <div class="iq-header-img">
                    <img src="{{ asset('admin/assets/images/dashboard/bg_header.png') }}" alt="header"
